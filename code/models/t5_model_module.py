# Author: Jingqi
# Create datetime: 2023/5/19 15:36
import json
import os
...
class T5Model(LightningModule):
    def __init__(self, model_name="t5-base", learning_rate=1e-5, batch_size=8, max_output_length=128,
    ...
    def training_step(self, batch, batch_idx):
        ...
        if torch.isnan(loss):
            ...
            source_text = self.tokenizer.batch_decode(source_ids)
